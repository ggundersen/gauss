class Odb:
    ...
    def get_canonical_data(cls):
        ...
        return [\
            ...
            [31, 73682, 'Coin sums'],\
            [32, 45228, 'Pandigital products'],\
            [33, 100, 'Digit canceling fractions'],\
            [34, 40730, 'Digit factorials'],\
            [35, 55, 'Circular primes'],\
            [36, 872187, 'Double-base palindromes'],\
            [37, 748317, 'Truncatable primes'],\
            [38, 932718654, 'Pandigital multiples'],\
            [39, 840, 'Integer right triangles'],\
            [40, 210, 'Champernowne\'s constant'],\
